//
//  ElegirUsuarioImgViewController.swift
//  WhatsAppIOS
//
...
class ElegirUsuarioImgViewController: UIViewController,UITableViewDataSource,UITableViewDelegate {
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        performSegue(withIdentifier: "enviarImagenSegue", sender: usuario)
    }

   
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        let siguienteVC = segue.destination as! EnviarImagenViewController
